    ...
    <section id="skills" className="pt-10 pb-24">
      ...
      <div className="md:flex md:justify-between md:gap-16 mt-3">
        ...
        >
          ...
          Technologies I use for projects developed in the field of web development...
          </p>
        </motion.div>
      ...
      <div className="md:flex md:justify-center mb-6 gap-16">
        {/* JAVASCRİPT */}
        <motion.div
        ...
        >
          ...
          core technologies of WWW, alongside HTML-CSS.
          </p>
        </motion.div>
        ...
        >
          ...
          Node.js is an open-source, cross-platform, back-end JavaScript runtime
           environment that runs on a JavaScript.
          </p>
        </motion.div>
      </div>
